...
export declare class NumberPickerComponent implements OnInit {
    ...
    private afterMouseWheels(wheelUp, event);
    ...
    private isArrowUpDown(keyCode);
    private isArowUp(keyCode);
    private loopPick(increase, event);
    onMouseUp(event: MouseEvent, increase?: boolean): void;
    onKeyDown(event: KeyboardEvent): void;
    onKeyUp(event: KeyboardEvent): void;
    private afterMouseDown(up, event);
    private afterMouseUp(up, event);
    private afterPick(up);
    private clearTimers();
    private afterArrowKeysPressed(up, event, start);
    private parseVal(value);
    private getPrecision(step);
    private round(value);
    private canIncrease();
    private canDecrease();
    private onPickStarted(increase);
    private onPickStoped(increase);
    private isLeftClick(witch);
    private initPicker();
}
